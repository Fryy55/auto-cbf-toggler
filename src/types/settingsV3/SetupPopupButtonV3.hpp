...
class SetupPopupButtonV3 final : public geode::SettingV3 {
public:
...
class SetupPopupButtonNodeV3 final : public geode::SettingNodeV3 {
public:
	static SetupPopupButtonNodeV3* create(std::shared_ptr<SetupPopupButtonV3> const&, float);

private:
	bool init(std::shared_ptr<SetupPopupButtonV3> const&, float);
